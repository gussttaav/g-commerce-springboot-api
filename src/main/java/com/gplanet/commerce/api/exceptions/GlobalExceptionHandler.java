...
import com.gplanet.commerce.api.dtos.api.ApiErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    private String extractDuplicateValue(String errorMessage) {
        try {
            int startIndex = errorMessage.indexOf(SINGLE_QUOTE) + 1;
            int endIndex = errorMessage.indexOf(SINGLE_QUOTE, startIndex);
